...
Java_com_snailstudio_xsdk_debug_serv_terminal_TermExec_sendSignal(JNIEnv *env, jobject clazz,
                                                                  jint procId, jint signal) {
    kill(procId, signal);
}

JNIEXPORT jint JNICALL
Java_com_snailstudio_xsdk_debug_serv_terminal_TermExec_waitFor(JNIEnv *env, jclass clazz,
                                                               jint procId) {
    int status;
...
JNIEXPORT jint JNICALL
Java_com_snailstudio_xsdk_debug_serv_terminal_TermExec_createSubprocessInternal(JNIEnv *env,
                                                                                jclass clazz,
                                                                                jstring cmd,
                                                                                jobjectArray args,
